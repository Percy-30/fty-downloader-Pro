...
export const metadata: Metadata = {
  metadataBase: new URL('https://www.ftydownloader.com'),// ✅ CON WWW
...
`,
  authors: [{ name: 'ATP DEV', url: 'https://www.ftydownloader.com/' }], // ✅ CON WWW
  creator: 'ATP DEV',
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.ftydownloader.com/images/og-image.png', // ✅ CON WWW
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://www.ftydownloader.com/images/og-image.png'], // ✅ CON WWW
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <html lang="es" suppressHydrationWarning>
      <head>
        ...
        <link rel="canonical" href="https://www.ftydownloader.com/" /> // ✅ CON WWW

        {/* Meta tags MANUALES para asegurar que funcione */}
        <meta property="og:image" content="https://www.ftydownloader.com/images/og-image.png" /> // ✅ CON WWW
        ...
        {/* Twitter Card Manual */}
        <meta name="twitter:image" content="https://www.ftydownloader.com/images/og-image.png" /> // ✅ CON WWW
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": "https://www.ftydownloader.com/", // ✅ CON WWW
              "image": "https://www.ftydownloader.com/images/og-image.png", // ✅ CON WWW
              "screenshot": "https://www.ftydownloader.com/images/og-image.png", // ✅ CON WWW
        ...
        <meta name="thumbnail" content="https://www.ftydownloader.com/images/og-image.png" /> // ✅ CON WWW
        <link rel="image_src" href="https://www.ftydownloader.com/images/og-image.png" /> // ✅ CON WWW
      </head>
